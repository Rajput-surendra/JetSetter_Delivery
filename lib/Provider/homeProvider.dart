...
//============================= For Language Selection =========================
  ...
  Future<Null> getCurrentOrder(
      Function update, BuildContext context, String lat, String long) async {
...
// lang:75.8979809
        ...
        parameter["lat"] = lat;
        parameter["lang"] = long;
        parameter["rejected_by"] = CUR_USERID.toString();
        ...
        if (!error) {
          if (offset! < total!) {
            ...
            length = orderList.length.toString();
